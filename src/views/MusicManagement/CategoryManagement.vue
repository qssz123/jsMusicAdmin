...
const categories = ref([
  { id: 1, name: '流行', status: 'enabled', statusText: '启用', createdAt: '2025-10-01' },
  { id: 2, name: '摇滚', status: 'disabled', statusText: '禁用', createdAt: '2025-10-05' },
  { id: 3, name: '爵士', status: 'enabled', statusText: '启用', createdAt: '2025-10-10' }
])
